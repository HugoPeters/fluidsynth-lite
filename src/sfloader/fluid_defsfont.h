...
/* Sound Font structure defines */
    ...
    typedef struct _SFData {
        ...
        void *sffd;			/* loaded sfont file descriptor */
...
#define ErrnoEnd	ErrWrite
    ...
    int safe_fwrite(void *buf, int count, void* fd);
    ...
    typedef void* (*func_open)(const char* filename);
    typedef int(*func_close)(void* handle);
    typedef int(*func_seek)(void* handle, int offs, int base);
    typedef int(*func_tell)(void* handle);
    typedef int(*func_rewind)(void* handle);
    typedef int(*func_read)(void* buff, int count, int size, void* handle);
    typedef int(*func_eof)(void* handle);
    ...
    void fluid_defsfont_set_callbacks(
        func_open callback_open
        , func_close callback_close
        , func_seek callback_seek
        , func_tell callback_tell
        , func_rewind callback_rewind
        , func_read callback_read
        , func_eof callback_eof);

...
struct _fluid_synth_t {
    ...
    fluid_atomic_int with_reverb;                   /**< Should the synth use the built-in reverb unit? */
    fluid_atomic_int with_chorus;            /**< Should the synth use the built-in chorus unit? */
    ...
    fluid_atomic_uint ticks_since_start;    /**< the number of audio samples since the start */
    ...
    fluid_atomic_float reverb_roomsize;      /**< Shadow of reverb roomsize */
    fluid_atomic_float reverb_damping;       /**< Shadow of reverb damping */
    fluid_atomic_float reverb_width;         /**< Shadow of reverb width */
    fluid_atomic_float reverb_level;         /**< Shadow of reverb level */

    int chorus_nr;                     /**< Shadow of chorus number */
    fluid_atomic_float chorus_level;         /**< Shadow of chorus level */
    fluid_atomic_float chorus_speed;         /**< Shadow of chorus speed */
    fluid_atomic_float chorus_depth;         /**< Shadow of chorus depth */
    fluid_atomic_int chorus_type;            /**< Shadow of chorus type */
    ...
    fluid_atomic_float cpu_load;             /**< CPU load in percent (CPU time required / audio synthesized time * 100) */
